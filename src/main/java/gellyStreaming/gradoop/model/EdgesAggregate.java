 ...
 * in the {@link SnapshotStream#aggregateNeighbors(Object, EdgesAggregate)} method.
 *
 * @param <K> the vertex ID type
 * @param <EV> the edge value type
 * @param <T> the accumulator type
 */
public interface EdgesAggregate<K, EV, T> extends Function, Serializable {
     ...
     * @return The data stream that is the result of applying the aggregateEdges function to the graph window.
     * @throws Exception
     */
    T aggregateEdges(T accumulator, K vertexID, K neighborID, EV edgeValue) throws Exception;
}