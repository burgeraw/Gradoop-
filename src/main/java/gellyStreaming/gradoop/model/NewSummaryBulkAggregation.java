...
public class NewSummaryBulkAggregation<K, EV, S extends Serializable, T> extends SummaryAggregation<K, EV, S, T> {

    private static final long serialVersionUID = 1L;
    protected long timeMillis;


    public NewSummaryBulkAggregation(EdgesFold<K, EV, S> updateFun, ReduceFunction<S> combineFun,
