 ...
 */
    ...
    private static final class FilterDistinctVertices<K>
        ...
        @Override
        public boolean filter(Vertex<K, NullValue> vertex) {
 ...
 */
    ...
    private static final class NeighborKeySelector<K, EV> implements KeySelector<Edge<K, EV>, K> {
        ...
        public K getKey(Edge<K, EV> edge) {
    ...
    private static final class VertexCountMapper<K> implements FlatMapFunction<Vertex<K, Long>, Long> {
        ...
        @Override
        public void flatMap(Vertex<K, Long> vertex, Collector<Long> out) {
    ...
    private static final class TotalEdgeCountMapper<K, EV> implements MapFunction<Edge<K, EV>, Long> {
        ...
        @Override
        public Long map(Edge<K, EV> edge) {
            edgeCount++;
            return edgeCount;
        }
    }
     ...
     */
    @Override
    public DataStream<Vertex<K, Long>> getDegrees() {
     ...
     */
    public DataStream<Vertex<K, Long>> getInDegrees() {
     ...
     */
    public DataStream<Vertex<K, Long>> getOutDegrees() {
    ...
    static final class DegreeTypeSeparator <K, EV>
        ...
        @Override
        public void flatMap(Edge<K, EV> edge, Collector<Vertex<K, Long>> out) {
            if (collectOut) {
    ...
    private static final class DegreeMapFunction <K>
        ...
        @Override
        public Vertex<K, Long> map(Vertex<K, Long> degree) {
            K key = degree.getId();
    ...
    private static final class GlobalAggregateMapper<VV> implements FlatMapFunction<VV, VV> {
        ...
        @Override
        public void flatMap(VV vv, Collector<VV> out) {
