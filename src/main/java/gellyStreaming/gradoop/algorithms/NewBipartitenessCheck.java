...
import gellyStreaming.gradoop.model.NewSummaryBulkAggregation;
 ...
 */
public class NewBipartitenessCheck<K extends Serializable, EV> extends NewSummaryBulkAggregation<K, EV,
        Candidates, Candidates> implements Serializable {
     ...
     */
    public NewBipartitenessCheck(long mergeWindowTime) {
